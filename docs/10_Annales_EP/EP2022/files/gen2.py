...
#     === "Énoncé" 
#         --8<-- "docs/10_Annales des épreuves pratiques/EP2022/files/{0}_1/enonce.md" 
# # 
# #     === "Correction"
# #         --8<-- "docs/10_Annales des épreuves pratiques/EP2022/files/{0}_1/correction.md" 
# 
# 
# ### Exercice {0}.2 □
# !!! example "Exercice {0}.2"
#     === "Énoncé" 
#         --8<-- "docs/10_Annales des épreuves pratiques/EP2022/files/{0}_2/enonce.md" 
# 
#     === "Correction"
#         --8<-- "docs/10_Annales des épreuves pratiques/EP2022/files/{0}_2/correction.md" 
# 
# 
#         ```             
#         """
...
with open('BNS_2022.md', 'a') as f:
    for val in lst:
        file = open ('./'+ val + '_1/' + 'enonce.md','a')
        f.write(contenu1.format(val))
