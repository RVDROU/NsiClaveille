...
class Snake :
    ...
    def __init__(self) :
        ...
        '''
        self.__position = Maillon((50,0),None)
    ...
    def ajout_tete(self) :
        ...
        if self.__orientation == 'bas' : val = (self.__position.valeur[0],self.__position.valeur[1]+1)
        elif self.__orientation == 'haut' : val = (self.__position.valeur[0],self.__position.valeur[1]-1)
        elif self.__orientation == 'droite' : val = (self.__position.valeur[0]+1,self.__position.valeur[1])
        elif self.__orientation == 'gauche' : val = (self.__position.valeur[0]-1,self.__position.valeur[1])
